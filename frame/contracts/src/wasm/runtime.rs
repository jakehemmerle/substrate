...
pub enum ReturnCode {
	...
	/// or is a tombstone.
	NotCallable = 8,
	/// The call to `seal_println` had to effect because debug message recording was
	/// disabled.
	LoggingDisabled = 9,
}
...
define_env!(Env, <E: Ext>,
	...
	// outputted to the console and to the calling RPC client. Specifying invalid UTF-8
	// triggers a trap.
	//
	// # Note
	//
	...
	[seal0] seal_println(ctx, str_ptr: u32, str_len: u32) -> ReturnCode => {
